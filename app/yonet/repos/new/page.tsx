...
export default function NewRepository() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Add New Repository</h1>
        <p className="text-gray-600 dark:text-gray-400">Add a new project repository to your portfolio</p>
      </div>
